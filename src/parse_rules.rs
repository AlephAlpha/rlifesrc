...
pub fn parse_isotropic(string: &str) -> Result<isotropic::Life, String> {
    ...
    let numbers = many(choice((
        ...
        token('1').with(chars_to_number!("ce",
            'c' => vec![0x01, 0x04, 0x20, 0x80],
            'e' => vec![0x02, 0x08, 0x10, 0x40])),
        token('2').with(chars_to_number!("cekain",
            ...
            'i' => vec![0x18, 0x42],
            'n' => vec![0x24, 0x81])),
        token('3').with(chars_to_number!("cekainyqjr",
        ...
        token('4').with(chars_to_number!("cekainyqjrtwz",
            'c' => vec![0xa5],
            'e' => vec![0x5a],
        ...
        token('5').with(chars_to_number!("cekainyqjr",
        ...
        token('6').with(chars_to_number!("cekain",
            ...
            'i' => vec![0xbd, 0xe7],
            'n' => vec![0x7e, 0xdb])),
        token('7').with(chars_to_number!("ce",
